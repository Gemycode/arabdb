    ...
    return (
        <div dir="rtl" className="relative w-full z-50">
            ...
            >
                        ...
                        <div className="hidden lg:flex items-center justify-center flex-1 mx-8">
                            <ul className="flex items-center gap-8">
                                {[
                                    ...
                                    { name: 'من نحن', path: '/AboutAs' }
                                ].map((item) => (
                                    <li key={item.name}>
                                        <button
                                            onClick={() => navigate(item.path)}
                                            className={`relative px-4 py-2 text-base font-bold whitespace-nowrap transition-all duration-300 group ${location.pathname === item.path ? 'text-amber-400' : 'text-gray-300 hover:text-white'
                                                }`}
                                        >
                ...
                {/* Mobile Menu Content */}
                <div
                    className={`mobile-menu lg:hidden fixed top-[138px] left-0 w-full h-[calc(100vh-138px)] bg-[#13151a] border-t border-white/10 shadow-2xl transition-all duration-300 z-40 overflow-y-auto ${isMobileMenuOpen ? 'translate-y-0 opacity-100 pointer-events-auto' : '-translate-y-2 opacity-0 pointer-events-none'
                        }`}
                >
            ...
            <div className="h-36 lg:h-40"></div>
        </div>
    );
};
